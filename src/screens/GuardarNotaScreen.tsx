...
import { CheckBox, Icon, Header as HeaderRNE } from '@rneui/themed';
...
export const GuardarNotaScreen = ({ navigation, route }: Props) => {
    ...
    const callbackCamera3 = (childData: any) => {
        setImage3(childData);
    }

    const callbackCamera4 = (childData: any) => {
        setImage4(childData);
    }       
                    ...
                    <FlatList
                        ...
                        ListFooterComponent={
                            <SafeAreaView>
                                ...
                                <TouchableOpacity style={ listStyle.button } onPress={tipoLegalizacion}>
                                    <Text style={ listStyle.buttonText }>Enviar</Text>
                                </TouchableOpacity>
                            </SafeAreaView>                   
                        } 
                    />                        
